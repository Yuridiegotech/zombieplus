package support.fixtures.movies;
...
public class MoviesData {
  ...
  private static void loadMovies() {
    if (moviesData == null) {
      try (BufferedReader reader = new BufferedReader(
          new FileReader("src/test/java/support/fixtures/movies/movies.json"))) {
        Gson gson = new Gson();
  ...
  public static java.util.List<Map<String, Object>> getMoviesList(Map<String, Object> map,
      String key) {
    Object value = map.get(key);
